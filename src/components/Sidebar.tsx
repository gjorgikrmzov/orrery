...
export const Sidebar = ({ neo, onClose }: { neo: NEO, onClose: () => void }) => (
    <motion.div initial={{x: 200, opacity: 0}} animate={{x: 0, opacity: 1}}  exit={{x: 200, opacity:0}} className="absolute h-full w-fit bg-black right-0 flex justify-center items-end  p-6" >
